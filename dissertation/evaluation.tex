...
boundaries.
\wip{ref to changing unsafety}
\todo{Least privilege for match arm/move bug?}
...
\todo{Rename: strengthening Rust?
least privilege and immutability---unable to override with unsafe? (UB
anyway! do anything including protect it. non-issue, this is resolved by
borrowck at compile time)}
