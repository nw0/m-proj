...
A source of undefined behaviour in Rust in the modification of an
immutable object.
This is ordinarily prevented by type-checking in Rust.
However, this is much harder to prevent when calling across a foreign
function interface, particularly since Rust has been designed as a safe
language, as opposed to any language it might call into.
...
\todo{a buffer-overflowing FFI program? Will this work?}

\todo{As explored in CHERI-JNI, but focus on object boundaries and
mutability. Can we add Rust guarantees across FFI boundaries?
