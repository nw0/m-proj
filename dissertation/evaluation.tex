...
\Cref{sec:eval-rust-enforce-immut} discusses this is more detail.
...
Rust's borrowing and lifetime models (\Cref{sec:rust-borrow}) makes
intentionality of use clear without placing the burden of memory
management on the programmer. \wip{write}
