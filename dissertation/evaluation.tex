...
However, as \Cref{sec:rust-unsafe} discusses, checks are
...
\clar{Why Rust is a natural choice for CHERI? Essentially, CHERI is less
likely to break Rust code than C code? Is this really a problem?
Provenance issues?}
