...
In the course of writing this report, another vulnerability in the Rust
standard library surfaced~\cite{rust-advisory-cast}: it permitted
arbitrary typecasting and hence buffer overflows.
