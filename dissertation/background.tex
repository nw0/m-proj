...
Watson et al.\ suggest that compartmentalisation with CHERI capabilities
vastly outperforms process-based approaches, as the data flow overhead
is non-existent~\cite{cheri2015}.
Note again that Robusta does more than improve memory safety: it also
intercepts system calls to ensure they conform to the Java security
model.
