...
Figure~\ref{lst:rust-ownership} shows some function signatures for
...
\clar{Move to evaluation? Need to show that LLVM takes away simple
bounds checks. Nevertheless, mention iterators? Discussed in next
section, with unchecked accesses.}
