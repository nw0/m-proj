...
\begin{figure}[ht]
    ...
    \lstinputlisting[language={[mips]Assembler}]{listings/array-itersum.s}
    \caption{
...
\begin{figure}[htp]
    ...
    \lstinputlisting[language={[mips]Assembler}]{listings/array-checkedsum.s}
    \caption{
...
\todo{This section feels a little out-of-place. We need to change the flow of this chapter.}
